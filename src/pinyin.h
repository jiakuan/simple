...
class PinYin {
 private:
  ...
  const std::map<std::string, char> tone_to_plain = {
      ...
      {"ế", 'e'}, {"ề", 'e'}, {"ō", 'o'}, {"ó", 'o'}, {"ǒ", 'o'}, {"ò", 'o'}, {"ī", 'i'}, {"í", 'i'},
      {"ǐ", 'i'}, {"ì", 'i'}, {"ū", 'u'}, {"ú", 'u'}, {"ǔ", 'u'}, {"ù", 'u'}, {"ǘ", 'u'}, {"ǚ", 'u'},
      {"ǜ", 'u'}, {"ń", 'n'}, {"ň", 'n'}, {"ǹ", 'n'}, {"ḿ", 'm'},
  };
  // 不是合法拼音，但是是前缀，只能出现在结尾·
  const std::set<std::string> pinyin_prefix = {
        "be","bia",
        "cen","ch","cho","chon","chua","co","con","cua",
        "den","dia","din","don","do","dua",
        "fe","fo",
        "go","gon",
        "ho","hon",
        "len","lo","lon","lua",
  ...
  const std::set<std::string> pinyin_valid = {
        ...
        "e", "en", "er",
        "fa", "fan", "fang", "fei", "fen", "feng", "fu", "fou",
        "ga", "gai", "gan", "gang", "gao", "ge", "gen", "geng",
